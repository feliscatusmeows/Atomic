package me.zeroX150.atomic.feature.gui.particles.moving;
...
public class ParticleManager {
    ...
    public void render(int cursorAlpha) {
        ...
        double renderX = Utils.Mouse.getMouseX();
        double renderY = Utils.Mouse.getMouseY();
        ...
        for (Particle particle : pl) {
            ...
            if (mdist < md * 5) {
                ...
                double dCalcR = Math.abs(1 - dCalc);
                Renderer.gradientLineScreen(Renderer.modify(particle.color, -1, -1, -1, (int) MathHelper.clamp(particle.brightness * 255 * dCalcR, 0, 255)), Renderer.modify(Utils.getCurrentRGB(), -1, -1, -1, (int) (255 * dCalcR * (cursorAlpha / 255d))), particle.x, particle.y, renderX, renderY);
            }
        }
    }
}
