...
import me.zeroX150.atomic.helper.util.MicrosoftLogin;
...
public class AltManagerScreen extends Screen implements FastTickable {
    ...
    protected void init() {
        ...
        login = new ButtonWidget(midpoint - widgetW / 2, 85 + 25, widgetW / 2 - 10, 20, Text.of("Login"), button -> {
            ...
            boolean done = Utils.Players.auth(username.getText(), password.getText());
            ...
            for (String s : l) {
                ...
                AltEntryWidget w = new AltEntryWidget(5, yOffset, width - maxW - 20, 40, un, pw) {
                    ...
                    public void event_mouseClicked() {
                        AltManagerScreen.this.username.setText(this.mail);
                        String pw = this.pw.equals("\003") ? "" : this.pw;
                        AltManagerScreen.this.password.setText(pw);
                    }
                    ...
                    public void event_altDeleted() {
                        ...
                        Atomic.client.setScreen(AltManagerScreen.this);
                    }
                };
                entries.add(w);
                yOffset += 45;
