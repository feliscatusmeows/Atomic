...
public class KeyListenerBtn extends ButtonWidget {
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (listening) this.setMessage(Text.of("... (- to clear)"));
        else {
        ...
        Atomic.fontRenderer.drawCenteredString(matrices, this.getMessage().getString(), x + width / 2f, y + height / 2f - 8 / 2f, ClickGUI.currentActiveTheme.fontColor().getRGB());
