...
public class AutoFish extends Module {
    ...
    @Override
    public void tick() {
        FishingBobberEntity fishingBobberEntity = Objects.requireNonNull(Atomic.client.player).fishHook;
        ...
        try {
            ...
            if (caughtFish) {
                Objects.requireNonNull(Atomic.client.interactionManager).interactItem(Atomic.client.player, Atomic.client.world,
                        Hand.MAIN_HAND);
